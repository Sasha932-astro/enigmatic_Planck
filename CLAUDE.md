...
- **Faculae pilot (session 2026-06-30, not yet persisted):** faculae are non-Planckian alone (corr~0.8). **Co-located** AR facular halos *lower* apparent T (cancel spots near disk center) and degrade the fit; **independent/diffuse network** faculae *raise* apparent T (5376→~5580 K at facula:spot area ratio G~4.5) while keeping corr≥0.997. The spot↔facula spatial relationship is decisive.

## Open questions for next session
0. **Faculae study (in progress):** push independent-network facula coverage G to realistic 5–20 to find the spot+facula balance reaching 5780 K; test facula-distribution dependence (faculae are μ-dependent so likely matters, unlike spots); AR-linked vs independent fraction; IR residual.
