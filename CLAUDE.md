...
0. **Penumbra & faculae distribution sweeps** — repeat `run_umbra_distribution_study`'s logic for the bright components; then study how the spot(cool)+facula(warm) **mixture** reconstructs the 5780 K curve (the real open problem).
